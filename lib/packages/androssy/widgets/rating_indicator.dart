...
class AndrossyRatingIndicator extends StatefulWidget {
  const AndrossyRatingIndicator({
    super.key,
  ...
  @override
  State<AndrossyRatingIndicator> createState() =>
      _AndrossyRatingIndicatorState();
}

class _AndrossyRatingIndicatorState extends State<AndrossyRatingIndicator> {
