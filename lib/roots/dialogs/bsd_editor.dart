...
class InAppEditorBottomSheet extends StatefulWidget {
  final String? hint;
  final String? title;
  final String? text;
  ...
  @override
  State<InAppEditorBottomSheet> createState() => _InAppEditorBottomSheetState();
}

class _InAppEditorBottomSheetState extends State<InAppEditorBottomSheet> {
