...
class BusinessAd extends Content {
  BusinessAd({
    // PUBLISHER
    super.publisherId,
  ...
  factory BusinessAd.create({
    ...
    return BusinessAd(
      ...
      publisherPhotoUrl: publisher.photo,
  ...
  factory BusinessAd.from(dynamic source) {
