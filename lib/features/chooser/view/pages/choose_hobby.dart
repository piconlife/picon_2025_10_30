...
import '../../data/models/hobby.dart';

const kHobbies = "hobbies";

class ChooseHobbyPage extends StatefulWidget {
  final Object? args;
  final bool multiSelection;

  const ChooseHobbyPage({super.key, this.args, this.multiSelection = false});

  @override
  State<ChooseHobbyPage> createState() => _ChooseHobbyPageState();
}

class _ChooseHobbyPageState extends State<ChooseHobbyPage> {
  ...
  late final _roots = InAppHobby.cache;
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        InAppText(
                          _single ? "What do you like" : "What do you likes",
              ...
              child: SingleChildScrollView(
                ...
                child: InAppSelection(
                  ...
                  listBuilder: (context, children) {
                    if (children.isEmpty) {
                      return InAppException("No hobby matched!");
                    }
                    return Wrap(
