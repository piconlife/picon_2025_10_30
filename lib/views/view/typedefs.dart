...
typedef OnViewItemChangeListener<T> =
...
typedef OnViewToggleHandler<T extends ViewController> =
    void Function(BuildContext context, T controller);
typedef OnViewAttachBuilder<T extends ViewController> =
    Widget? Function(BuildContext context, T controller);
typedef OnViewModifyBuilder<T extends ViewController> =
    Widget Function(BuildContext context, T controller, Widget parent);
typedef OnViewNotifier = void Function(VoidCallback fn);
typedef OnViewNotifyListener<T extends ViewController> =
