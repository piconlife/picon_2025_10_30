...
typedef EditTextDrawableBuilder<T extends EditTextController> =
    Widget Function(BuildContext context, T controller);

typedef EditTextContextMenuBuilder =
    Widget Function(BuildContext context, EditableTextState state);

typedef EditTextPrivateCommandListener =
...
typedef EditTextSelectionChangeListener =
